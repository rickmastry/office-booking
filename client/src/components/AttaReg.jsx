            ...
            <form className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
                ...
                <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
                    ...
                    <div className='w-full mt-4'>
                        ...
                        <input id='name' className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" type="text" placeholder='Type here...' required />
                    </div>
                    {/*Phone */}
                    <div className='w-full mt-4'>
                        <label htmlFor="contact" className='font-medium text-gray-500'>Phone</label>
                        <input id='contact' className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" type="text" placeholder='Type here...' required />
                    </div>
                    {/*Address */}
                    <div className='w-full mt-4'>
                        <label htmlFor="address" className='font-medium text-gray-500'>Address</label>
                        <input id='address' className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" type="text" placeholder='Type here...' required />
                    </div>
