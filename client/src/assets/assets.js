...
import coffee from "./coffeeIcon.svg";
import beach from "./beach.svg"
import abcRound from "./abc_round_blue.png"
...
export const facilityIcons = {
    ...
    "Beach Side": assets.beach,
    "Pool Access": assets.poolIcon,
    "Free Coffee": assets.coffee
};
...
export const hotelDummyData = {
    ...
    "name": "Atta Business Center",
    "address": "1000 Sea Mountain Hwy",
    "contact": "+1842819500",
    "owner": userDummyData,
...
export const roomsDummyData = [
    {
        ...
        "roomType": "Co-workspace",
        "pricePerNight": 20.00,
         "pricing": [
            { price: 20.00, billingCycle: "daily" },
            { price: 6.00, billingCycle: "hour" }
            ],
        "amenities": ["Free WiFi", "Beach Side", "Free Coffee"],
        "shredding": 5.00,
    ...
    },
    {
        ...
        "hotel": hotelDummyData,
        "roomType": "Dedicated Work Space",
        "pricePerNight": 295,
         "pricing": [
            { price: 295.00, billingCycle: "month" },
            ],
        "amenities": ["Free WiFi", "Beach Side", "Free Coffee"],
    ...
    },
    {
        ...
        "pricePerNight": 249,
         "pricing": [
            { price: 190.00, billingCycle: "daily" },
            { price: 25.00, billingCycle: "hour" },
            {price: 90.00, billingCycle: "half-day"}
            ],
        "amenities": ["Free WiFi", "Beach Side", "Free Coffee"],
    ...
    },
    {
        ...
        "pricePerNight": 550,
         "pricing": [
            { price: 600.00, billingCycle: "month" },
            ],
        "amenities": ["Free WiFi", "Beach Side", "Free Coffee"],
