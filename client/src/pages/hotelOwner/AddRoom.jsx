            ...
            <form>
                ...
                <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                    <div className='flex-1 max-w-48'>
                        <p className='text-gray-800 mt-4'>Office Type</p>
                        <select className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full' value={inputs.roomType} onChange={(e) => setInputs({ ...inputs, roomType: e.target.value })}>
                            ...
                            <option value='Single Bed'>Co Workspace</option>
                            <option value='Double Bed'>Dedicated Worfspace</option>
                            <option value='Luxury Room'>Private Office</option>
                            <option value='Family Suite'>Phone Pod</option>
                        </select>
                    </div>
                    <div>
